...
// POST /intelligent-tags/suggestions/:suggestionId/pitches - Generate pitches for a suggestion
router.post('/suggestions/:suggestionId/pitches', async (req, res) => {
    try {
        const { suggestionId } = req.params;
        const { count = 3 } = req.body;

        const result = await intelligentTagService.generatePitches(suggestionId, count);
        res.json({ success: true, ...result });
    } catch (error) {
...
// GET /intelligent-tags/suggestions/:suggestionId/pitches - Get pitches for a suggestion
router.get('/suggestions/:suggestionId/pitches', async (req, res) => {
    try {
        const { suggestionId } = req.params;

        const result = await intelligentTagService.getPitches(suggestionId);
        res.json({ success: true, ...result });
    } catch (error) {
...
// DELETE /intelligent-tags/pitches/:pitchId - Delete a specific pitch
router.delete('/pitches/:pitchId', async (req, res) => {
    try {
        const { pitchId } = req.params;

        const result = await intelligentTagService.deletePitch(pitchId);
        res.json({ success: true, ...result });
    } catch (error) {
...
// DELETE /intelligent-tags/suggestions/:suggestionId/pitches - Delete all pitches for a suggestion
router.delete('/suggestions/:suggestionId/pitches', async (req, res) => {
    try {
        const { suggestionId } = req.params;

        const result = await intelligentTagService.deleteAllPitches(suggestionId);
        res.json({ success: true, ...result });
    } catch (error) {
...
// POST /intelligent-tags/pitches/:pitchId/rate - Rate a pitch
router.post('/pitches/:pitchId/rate', async (req, res) => {
    try {
        const { pitchId } = req.params;
        const { rating, comment } = req.body;
        ...
        const result = await intelligentTagService.ratePitch(pitchId, rating, comment);
        res.json({ success: true, ...result });
    } catch (error) {
...
// POST /intelligent-tags/pitches/:pitchId/favorite - Toggle favorite status for a pitch
router.post('/pitches/:pitchId/favorite', async (req, res) => {
    try {
        const { pitchId } = req.params;

        const result = await intelligentTagService.togglePitchFavorite(pitchId);
        res.json({ success: true, ...result });
    } catch (error) {
